...
public class SensitivewordFilter {
    ...
    public static void main(String[] args) {
        ...
        String string = "杜智富阿宾太多的伤感情怀小泽玛莉亚也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的专业投票很潇洒地释自杀指南怀那些自己经历的伤感。"
                + "然后法轮功 我们的扮演的角色就是法轮功跟随着主微信投票人公的喜红法轮功客联盟 怒哀乐微投而过于牵强的把自己的情感也附法轮功加于银幕情节微投中，然后感动就流泪，"
                + "难过就躺在某办证一个人的怀投票团队里尽情的阐述心扉或者专业投票手机卡复制器一个法轮功人一杯红酒一部电影在夜三级片 深人静的晚上，关上电话静静的发呆着。";
//        String string ="厉害";
